        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center px-4 md:flex-row mt-20' >
            ...
            <div className='flex flex-col justify-center'>
                ...
                <div className='mt-4'>
                    ...
                    <p className='text-gray-500 pt-4 pb-1 pr-8'>100% accurate AI was released July 30, 2024 at <a href="https://www.ragfix.ai" style="text-decoration:underline;">RAGFix</a>.</p>
