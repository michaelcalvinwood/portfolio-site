  ...
  return (
    <div id='about' name="about" className='pt-20 lg:pt-0 w-full lg:h-screen bg-gradient-to-b from-gray-800 to-black text-white'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center h-full w-full'>
            ...
            <p className='text-xl'>My current employment involves a combination of Nodejs, React, Redux, PHP, Python, SQL, Redis, MongoDB, LangChain, Qdrant, WordPress, Javascript, HTML, CSS, Ionic, and Nextjs. I also manage all DevOps as well.
            </p>
            <br />
            <p className='text-xl'>
